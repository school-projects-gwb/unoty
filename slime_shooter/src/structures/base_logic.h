#ifndef SLIME_SHOOTER_SRC_structures_SLIME_SHOOTER_SRC_structures_BASE_LOGIC_H_
#define SLIME_SHOOTER_SRC_structures_SLIME_SHOOTER_SRC_structures_BASE_LOGIC_H_
...
#endif //SLIME_SHOOTER_SRC_structures_SLIME_SHOOTER_SRC_structures_BASE_LOGIC_H_
